...
use function Stage\stage_build_js_object;
use function Stage\stage_is_shop_active;

/**
 * Register Stage Parent Theme Assets
 */
add_action(
    'wp_enqueue_scripts',
    function () {
...
add_action(
    ...
    function () {
        wp_enqueue_script(
            'stage-child/app.js',
            asset('scripts/app.js', 'theme')->uri(),
            array(
                'jquery',
            ),
            null,
        ...
        wp_enqueue_style('stage-child/app.css', asset('styles/app.css', 'theme')->uri(), false, null);
    },
    100
);
